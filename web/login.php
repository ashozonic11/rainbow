...
if (isset($_POST['submit'])) {
  ...
  $query=mysqli_query($con,"SELECT * FROM user WHERE Username='".$username."' AND Password='".$encrypted_password."'");
...
<html>
  ...
  <button type="submit" class="btn btn-default" name="submit"><a href="index.php">Submit<a></button><br/><br/><a>
If you don't have an account then,</a> <a href="register.php"> register here.<a>
</form>
